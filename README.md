...
### Beta
* `0.1.2b` - SHA1 fixed error. General code changes (renaming classes, private methods, new methods...). Changing library namespace to 'Hashes'. Starting code documentation. Added new examples of how to use. 
